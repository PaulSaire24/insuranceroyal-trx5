...
public class MockBundleContext implements BundleContext,
	...
	public Bundle getBundle() {
		...
		Mockito.when(mockBundle.getSymbolicName()).thenReturn("PISDR008IMPL-0.2.1-SNAPSHOT");
		Mockito.when(mockBundle.getVersion()).thenReturn(new Version("0.2.1-SNAPSHOT"));
		return mockBundle;
	}
